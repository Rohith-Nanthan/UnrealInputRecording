...
struct UNREALINPUTRECORDING_API FRecordedInputSample
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UNREALINPUTRECORDING_API FInputRecordingHeader
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct UNREALINPUTRECORDING_API FInputRecording
{
	GENERATED_BODY()
