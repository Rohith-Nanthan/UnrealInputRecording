...
UNREALINPUTRECORDING_API FArchive& operator<<(FArchive& Ar, FRecordedInputSample& Sample);
UNREALINPUTRECORDING_API FArchive& operator<<(FArchive& Ar, FInputRecordingHeader& Header);
UNREALINPUTRECORDING_API FArchive& operator<<(FArchive& Ar, FInputRecording& Recording);
 ...
 */
UCLASS()
class UNREALINPUTRECORDING_API UInputRecordingSerializer : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
