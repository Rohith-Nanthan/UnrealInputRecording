...
public:
	...
	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.InputRecorderOverlayWidget"))
	FSoftClassPath OverlayWidgetClass;

	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.SyncPointRowWidget"))
	...
	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.VideoSurfaceWidget"))
	FSoftClassPath VideoSurfaceWidgetClass;

	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.MatchCueMarkerWidget"))
	FSoftClassPath MatchCueMarkerWidgetClass;

	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.WrongInputRowWidget"))
	FSoftClassPath WrongInputRowWidgetClass;

	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.RecordingListWidget"))
	FSoftClassPath RecordingListWidgetClass;

	UPROPERTY(config, EditAnywhere, Category = "UI", meta = (MetaClass = "/Script/UnrealInputRecording.RecordingListRowWidget"))
